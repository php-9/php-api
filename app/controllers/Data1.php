...
class Data1 extends Home_Controller {

	public function __construct(){
		parent::__construct();
		
		//判断权限	
		$user=empty($_SESSION['user']) ? array() : $_SESSION['user'];
	...
	public function index(){
		...
		$config['num_links'] = 3;
		$config['base_url']=site_url('data1/index'."
		...
		$this->load->view('home/data1.htm',$data);
		
	}


	public function add(){
		$this->load->view('home/data1_add.htm');
	}
	...
	public function edit($id){
		...
		$this->load->view('home/data1_edit.htm',$data);
	}
	...
	public function edit_pass($id){
		...
		if( $this->db->where('id',$id)->update('data1',$data) ){
			...
			$this->msg('数据编辑成功',site_url('data1/index'));
		}
	...
	public function del($id){
		...
		if( $this->db->where('id',$id)->update('data1',$data) ){
			...
			$this->msg('已删除',site_url('data1/index'));
		}
	...
	public function import(){
		$this->load->view('home/data1_import.htm');
	}
	...
	public function import_pass(){
		...
		$this->msg('数据导入成功',site_url('data1/index'));
