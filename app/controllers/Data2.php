...
class Data2 extends Home_Controller {
	...
	public function index(){
		...
		$config['num_links'] = 3;
		$config['base_url']=site_url('data2/index'."
		...
		$this->load->view('home/data2.htm',$data);
	...
	public function edit($id){
		...
		$this->load->view('home/data2_edit.htm',$data);
	}
	...
	public function edit_pass($id){
		...
		if( $this->db->where('id',$id)->update('data2',$data) ){
			...
			$this->msg('数据编辑成功',site_url('data2/index'));
		}
	...
	public function del($id){
		...
		if( $this->db->where('id',$id)->update('data2',$data) ){
			...
			$this->msg('已删除',site_url('data2/index'));
		}
