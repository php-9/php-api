...
class Admin_log extends Admin_Controller{
	...
	public function index(){
		...
		$config['num_links'] = 3;
		$config['base_url']=site_url('admin_log/index'."
		...
		$this->load->view('admin/admin_log.htm',$data);
	...
	public function del($id){
		...
		if($this->db->where('id',$id)->delete('admin_log') ){
			$this->msg('删除成功',admin_url('admin_log/index'));
		}
